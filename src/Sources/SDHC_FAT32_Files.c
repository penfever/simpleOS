...
/*write_cache writes the contents of the cache to disk 
and sets the dirty flag to clean, or returns an error 
...
/*updates logicalSector with the value for the current working directory
and reads the data from that dir-entry into 'data'.*/
